  ...
  return (
    <section style={{ position: 'relative', width: '100%', height: '100svh', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div style={{
          position: 'absolute', inset: 0,
          background: 'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(0,0,0,0.42) 0%, transparent 80%)',
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          {/* Logo */}
          <div className="reveal-hero" style={{ animationDelay: '0.15s' }}>
            <Image
              ...
              style={{
                ...
                display: 'block',
                marginBottom: '-90px',
                filter: 'drop-shadow(0 0 8px rgba(0,0,0,1)) drop-shadow(0 8px 30px rgba(0,0,0,1)) drop-shadow(0 16px 60px rgba(0,0,0,1)) drop-shadow(0 0 24px rgba(255,255,255,0.08))',
              }}
              priority
            />
          </div>
      ...
      <style>{`
        ...
        .sh-letter {
          ...
          animation: letterUp 0.55s cubic-bezier(0.22,1,0.36,1) forwards;
          text-shadow:
